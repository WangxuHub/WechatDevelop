<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="WebChatDep.Content.Index" %>

<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta property="qc:admins" content="6511416114516013066547" />
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- 上述3个meta标签*必须*放在最前面，任何其他内容都*必须*跟随其后！ -->
    <title>WangxuHub</title>
    <link rel="shortcut icon" href="/Resource/image/shortCut.ico">
    <!-- Bootstrap -->
